...
###################################################################################
# Table  predicting systemic volatility with ivol dictionaries D0 for Earnings calls
###################################################################################

## Load data
meta <- read.csv("data/output/volatility_signals/regression_sysvol.csv")
...
writeLines(reg_summary, "data/output/predicting_sysvol/results.txt")
...
write.csv(coefficients_df, file='data/output/predicting_sysvol/coeffs.csv', row.names=FALSE)
